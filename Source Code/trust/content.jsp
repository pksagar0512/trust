...
%>
	...
	try{
		...
		while(rs1.next()){
			...
			%>
          <tr class="light"> 
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getInt("id")%></a></td>
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("tag")%></a></td>
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("date")%></a></td>
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("lyke")%></a></td>
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("report")%></a></td>
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("imagestatus")%></a></td>
            <td><a href="content1.jsp?select=<%=rs1.getInt("id")%>">Change</a></td>
