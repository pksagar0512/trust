...
<%
				...
				try
				{
					...
					String qry="select * from view where email='"+email+"'";
...
<div class="wrapper col3">
  <div id="container" class="clear"> 
	...
	while(rs.next())
	  ...
	  <ul>
        <li><a href="view2.jsp?id=<%=id%>" rel="prettyPhoto[gallery1]" title="Image 1">
		<img src="view2.jsp?id=<%=id%>" alt="" /></a> 
          <strong>From&nbsp;<%=rs.getString("name")%>&nbsp;on&nbsp;<%=rs.getString("date")%>
		  </td>
		  
		<%}%>  
		<!--    </strong></li>
        <%if(rs.next()){%>
        <li><a href="view2.jsp?id=<%=rs.getString("id")%>" rel="prettyPhoto[gallery1]" title="Image 2"><img src="view2.jsp?id=<%=rs.getString("id")%>" alt="" /></a> 
          <strong>From&nbsp;<%=rs.getString("from1")%>&nbsp;on&nbsp;<%=rs.getString("date")%></strong></li>
        <%}%>
        <%if(rs.next()){%>
        <li class="last"><a href="view2.jsp?id=<%=rs.getString("id")%>" rel="prettyPhoto[gallery1]" title="Image 3"><img src="view2.jsp?id=<%=rs.getString("id")%>" alt="" /></a> 
          <strong>From&nbsp;<%=rs.getString("name")%>&nbsp;on&nbsp;<%=rs.getString("date")%></strong></li>
