...
%>
	...
	try{
		...
		while(rs1.next()){
			...
			%>
          <tr class="light"> 
            <td><a href="admin.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getInt("id")%></a></td>
            <td><a href="admin.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("name")%></a></td>
            <td><a href="admin.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("email")%></a></td>
            <td><a href="admin.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("status")%></a></td>
            <td><a href="admin.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("report")%></a></td>
            <td><a href="admin.jsp?select=<%=rs1.getInt("id")%>"><%=rs1.getString("upload")%></a></td>
